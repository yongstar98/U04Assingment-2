...
void ACPlayer::BeginPlay()
{
	...
	WeaponWidget->BulletsCount(Weapon->GetMaxBullets(), Weapon->GetCurrentBullets());
}
...
void ACPlayer::CallCountBullets(int32 MaxBullets, int32 CurrnetBullets)
{
	WeaponWidget->BulletsCount(MaxBullets, CurrnetBullets);
}
